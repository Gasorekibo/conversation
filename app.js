...
import { analyzeWithGemini } from './helpers/geminiPromptFormat.js';
...
app.post('/api/chat', async (req, res) => {
  try {
    ...
    if (shouldCallBackend) {
      ...
      const resultMessage = formatBackendResponse(
        conversation.intent,
        backendResult
      );
